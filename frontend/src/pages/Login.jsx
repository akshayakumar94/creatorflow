            ...
            <div className="relative z-10 w-full max-w-md animate-slide-up">
                ...
                <div className="text-center mb-10">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-brand-600 rounded-2xl
                          shadow-2xl shadow-brand-900/50 mb-5 rotate-3">
                ...
                {/* Card */}
                <div className="card glow-brand border-brand-600/20">
                    <div className="text-center mb-8">
                        <h2 className="text-2xl font-bold text-white">Welcome back</h2>
                        <p className="text-gray-400 text-sm mt-1">Sign in to manage your content calendar</p>
                    </div>

                    {error && (
                        <div className="mb-5 p-3 bg-red-500/10 border border-red-500/30 rounded-xl text-red-400
                            text-sm text-center">
                    ...
                    <button
                       ...
                       text-gray-900 font-semibold py-3.5 px-6 rounded-xl transition-all duration-200
                ...
                <div className="flex items-center justify-center gap-6 mt-8 text-xs text-gray-500">
                    {["AI Content Generation", "30-Day Calendar", "Multi-Platform"].map((f) => (
